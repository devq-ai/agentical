...
class BaseModel(Base):
    ...
    # Store metadata in a JSON column if available, otherwise use String
    try:
        metadata_col = Column(MutableDict.as_mutable(JSONB), nullable=True)
    except ImportError:
        metadata_col = Column(String, nullable=True)
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        for column in self.__table__.columns:
            ...
            if column.name == 'metadata_col' and isinstance(value, str):
                try:
    ...
    def metadata(self) -> Dict[str, Any]:
        ...
        try:
            return json.loads(self.metadata_col)
        except (json.JSONDecodeError, TypeError):
            return {}
    ...
    def metadata(self, value: Dict[str, Any]) -> None:
        """Set metadata."""
        if isinstance(self.metadata_col, dict):
            self.metadata_col = value
        else:
            self.metadata_col = json.dumps(value)
